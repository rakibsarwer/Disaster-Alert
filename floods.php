                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="challange_text_inner">
                            ...
                            <p>
							Flood occurs when a large amount of water covers an area. It generally occurs due to heavy rainfall. Flood also occurs when a river overflows its water due to heavy rainfall. A flood is dangerous and it causes damage to life and property. Flood water submerges everything when it enters an area. India witnesses numerous floods in a year. The reason behind these flood is the rainy season between June and September. 
							</p><div class="c_video">
                    ...
                    <div class="col-lg-6">
                        <div class="left_company_text">
                            <div class="l_title">
                                <img src="img/icon/title-icon.png" alt="">
                                <h6>Discover the features</h6>
                                <h2>Flood Monitoring And Analysis</h2>
                            </div>
