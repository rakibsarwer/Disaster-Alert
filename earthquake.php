                    ...
                    <div class="col-lg-6">
                        <div class="challange_text_inner">
                            <div class="l_title">
                                ...
                                <h2>What is Earthquake</h2>
                            </div>
                            <p>
							Earthquakes are usually caused when rock underground suddenly breaks along a fault. This sudden release of energy causes the seismic waves that make the ground shake. When two blocks of rock or two plates are rubbing against each other, they stick a little. They don't just slide smoothly; the rocks catch on each other. The rocks are still pushing against each other, but not moving. After a while, the rocks break because of all the pressure that's built up. When the rocks break, the earthquake occurs. During the earthquake and afterward, the plates or blocks of rock start moving, and they continue to move until they get stuck again. The spot underground where the rock breaks is called the focus of the earthquake. The place right above the focus (on top of the ground) is called the epicenter of the earthquake. Earthquakes are recorded by a device called seismograph. Richter scale is the scale which is used to measure the magnitude of earthquake. 
							</p>
							<div class="c_video">
...
o	Make sure you have a fire extinguisher, first aid kit, a battery-powered radio, a flashlight, and extra batteries at home.
o	Learn first aid.
o	Learn how to turn off the gas, water, and electricity.
o	Make up a plan of where to meet your family after an earthquake.
o	Don't leave heavy objects on shelves (they'll fall during a quake).
o	Anchor heavy furniture, cupboards, and appliances to the walls or floor. 
...
o	Stay calm! If you're indoors, stay inside. If you're outside, stay outside.
o	If you're indoors, stand against a wall near the center of the building, stand in a doorway, or crawl under heavy furniture. 
o	If you're outdoors, stay in the open away from power lines or anything that might fall. Stay away from buildings (stuff might fall off the building or the building could fall on you).
o	Don't use matches, candles, or any flame. Broken gas lines and fire don't mix. 
o	If you're in a car, stop the car and stay inside the car until the earthquake stops.
o	Don't use elevators (they'll probably get stuck anyway). 
...
o	Check yourself and others for injuries. Provide first aid for anyone who needs it. 
o	Check water, gas, and electric lines for damage. If any are damaged, shut off the valves. Check for the smell of gas. If you smell it, open all the windows and doors, leave immediately, and report it to the authorities (use someone else's phone). 
o	Turn on the radio. Don't use the phone unless it's an emergency. 
o	Be careful around broken glass and debris. Wear boots or sturdy shoes to keep from cutting your feet. 
o	Be careful of chimneys (they may fall on you). 
o	Stay away from damaged areas. 
                    ...
                    <div class="col-lg-6">
                        <div class="left_company_text">
                            <div class="l_title">
                                <img src="img/icon/title-icon.png" alt="">
                                <h6>Discover the features</h6>
                                <h2>Earthquake Monitoring And Analysis</h2>
                            </div>
                            <p></div>
                    </div>
                    <div class="col-lg-6">
        ...
        <section class="service_feature">
			...
			<div class="row">
                    <div class="col-lg-12">
                        <div class="service_text_inner">
                            <div class="l_title">
                                <img src="img/icon/title-icon.png" alt="">
                                <h6>Discover the features</h6>
                                <h2>Plan and Preparation</h2>
